...
public class ShowcaseView extends RelativeLayout
    ...
    public static class Builder {
        ...
        /**
         * Set the duration of the fading in of the ShowcaseView
         */
        public Builder setFadeInDurations(long fadeInMillis) {
            showcaseView.setFadeInDurations(fadeInMillis);
            return this;
        }
    }
     ...
     * Set the duration of the fading in of the ShowcaseView
     */
    public void setFadeInDurations(long fadeInMillis) {
        this.fadeInMillis = fadeInMillis;
    }
