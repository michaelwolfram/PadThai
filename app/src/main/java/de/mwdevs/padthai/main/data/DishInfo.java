...
public enum DishInfo {
    ...
    TOM_YAM_SOUP(4, R.string.tom_yam_soup, R.drawable.tom_yam_soup_512, 7,
            new ArrayList<>(Arrays.asList(
                    new DishComponentInfo(R.string.chili_paste, "chili_paste.json"),
                    new DishComponentInfo(R.string.peanut_sauce, "peanut_sauce.json"),
                    new DishComponentInfo(R.string.pad_thai, "pad_thai.json")
            ))),
    SPRING_ROLLS(5, R.string.spring_roles, R.drawable.spring_roles_512, 10,
            new ArrayList<>(Arrays.asList(
                    new DishComponentInfo(R.string.chili_paste, "chili_paste.json"),
                    new DishComponentInfo(R.string.peanut_sauce, "peanut_sauce.json")
            ))),
    PUMPKIN_HUMUS(6, R.string.pumpkin_humus, R.drawable.pumpkin_humus_512, 12,
            new ArrayList<>(Collections.singletonList(
                    new DishComponentInfo(R.string.chili_paste, "chili_paste.json")
            ))),
    MANGO_WITH_STICKY_RICE(7, R.string.mango_sticky_rice, R.drawable.mango_sticky_rice_512, 13,
            new ArrayList<>(Arrays.asList(
                    new DishComponentInfo(R.string.chili_paste, "chili_paste.json"),
                    new DishComponentInfo(R.string.peanut_sauce, "peanut_sauce.json")
            )));
